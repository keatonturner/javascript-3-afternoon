...
let newEmployee = new Employee("jamal", "jenkins", "jamal@jamal.com", 65)
...
// const Manager = Object.assign({}, newEmployee.{reports: reports= []})
  class Manager {
    constructor(first, last, email, age){
      this.first_name = first;
    this.last_name = last;
